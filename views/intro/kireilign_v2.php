...
<!-- wp:sgb/splide {"items":[{"image":"<?php echo esc_url(get_stylesheet_directory_uri() . '/images/intro/kireilign_v2/1.webp'); ?>","id":"fDmY1p9i8"},{"image":"<?php echo esc_url(get_stylesheet_directory_uri() . '/images/intro/kireilign_v2/2.webp'); ?>","id":"0nPQaI7e-"},{"image":"<?php echo esc_url(get_stylesheet_directory_uri() . '/images/intro/kireilign_v2/3.webp'); ?>","id":"dlbBfTwMF"},{"image":"<?php echo esc_url(get_stylesheet_directory_uri() . '/images/intro/kireilign_v2/4.webp'); ?>","id":"d1pYOj10C"},{"image":"<?php echo esc_url(get_stylesheet_directory_uri() . '/images/intro/kireilign_v2/5.webp'); ?>","id":"ZslFDKyj4"},{"image":"<?php echo esc_url(get_stylesheet_directory_uri() . '/images/intro/kireilign_v2/6.webp'); ?>","id":"J1C-5PA2L"},{"image":"<?php echo esc_url(get_stylesheet_directory_uri() . '/images/intro/kireilign_v2/7.webp'); ?>","id":"X0RbjcWCw"},{"image":"<?php echo esc_url(get_stylesheet_directory_uri() . '/images/intro/kireilign_v2/8.webp'); ?>","id":"bjBNJpySe"},{"image":"<?php echo esc_url(get_stylesheet_directory_uri() . '/images/intro/kireilign_v2/9.webp'); ?>","id":"8fwPOUekw"},{"image":"<?php echo esc_url(get_stylesheet_directory_uri() . '/images/intro/kireilign_v2/10.webp'); ?>","id":"sTZ2k2wlJ","url":"https://kireilign.com/lp/a/lp189/"}],"sliderHeight":100,"autoplay":true,"autoplaySpeed":0} -->
