<div class="shindan_default shadow">
  ...
  <div id="modal" class="">
    <div id="questions-container" class="diagnose_container">
      <?php include(get_stylesheet_directory() . '/views/components/shindan/default/questions/q1.php'); ?>
      <?php include(get_stylesheet_directory() . '/views/components/shindan/default/questions/q2.php'); ?>
      <?php include(get_stylesheet_directory() . '/views/components/shindan/default/questions/q3.php'); ?>
      <?php include(get_stylesheet_directory() . '/views/components/shindan/default/questions/q4.php'); ?>
      <?php include(get_stylesheet_directory() . '/views/components/shindan/default/questions/q5.php'); ?>
    </div>
    <?php include(get_stylesheet_directory() . '/views/components/shindan/default/cta/kireilign.php'); ?>
  </div>

  <script>
    (function() {
      const container = document.querySelector('.shindan_default');
