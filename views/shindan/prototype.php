<!-- wp:html -->
<div class="clinic_shindan_prt shadow">
  ...
  <div id="shindan_container" class="">
    <div id="questions-container" class="diagnose_container">
      <?php include(get_stylesheet_directory() . '/views/components/shindan/prt/questions/q1.php'); ?>
      <?php include(get_stylesheet_directory() . '/views/components/shindan/prt/questions/q2.php'); ?>
      <?php include(get_stylesheet_directory() . '/views/components/shindan/prt/questions/q3.php'); ?>
    </div>
    <?php include(get_stylesheet_directory() . '/views/components/shindan/prt/cta/kireilign.php'); ?>
  </div>

  <script>
    (function() {
      const container = document.querySelector('.clinic_shindan_prt');
