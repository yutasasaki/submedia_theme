...
<div id="question1" class="question">
  ...
  <img style="border:4px solid; border-color:<?php echo get_theme_mod('submedia_main_color_setting', '#009EF3'); ?>;" class="w-full h-auto mx-auto rounded-xl mb-2" src="<?php echo esc_url(get_stylesheet_directory_uri() . '/images/shindan/banner/price.webp'); ?>" alt="治療の価格">
