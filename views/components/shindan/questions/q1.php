...
<div id="question1" class="question">
  ...
  <p class="question-text font-semibold">矯正の費用はなるべく抑えたい？</p>
  ...
  <div class="options grid grid-cols-1 gap-4">
    <button class="option bg-white w-full" data-selected-answer="矯正の費用はなるべく安くしたい">できれば安くしたい！</button>
    <button class="option bg-white w-full" data-selected-answer="矯正の費用は高くても気にしない">高くても気にしない！</button>
  </div>
</div>