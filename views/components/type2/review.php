...
<!-- wp:sgb/say {"balloonBackgroundColor":"#fff","balloonBorderColor":"<?php echo get_theme_mod('main_color', '#009EF3'); ?>","avatarBorderColor":"<?php echo get_theme_mod('main_color', '#009EF3'); ?>"} -->
<div class="wp-block-sgb-say">
  <div class="sgb-block-say sgb-block-say--left">
    <div class="sgb-block-say-avatar"><img src="https://www.gravatar.com/avatar/?d=mm" width="80" height="80"
        style="border-color:<?php echo get_theme_mod('main_color', '#009EF3'); ?>" />
      <div class="sgb-block-say-avatar__name"></div>
    </div>
    <div class="sgb-block-say-text">
      <div class="sgb-block-say-text__content" style="color:#333;border-color:<?php echo get_theme_mod('main_color', '#009EF3'); ?>;background-color:#fff">
        <!-- wp:paragraph -->
        ...
        <!-- /wp:paragraph --><span class="sgb-block-say-text__before" style="border-right-color:<?php echo get_theme_mod('main_color', '#009EF3'); ?>"></span><span
